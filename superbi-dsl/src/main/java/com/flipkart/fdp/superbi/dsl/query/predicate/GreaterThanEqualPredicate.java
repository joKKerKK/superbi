 ...
 * Time: 11:28 AM
 */
public class GreaterThanEqualPredicate extends BinaryPredicate<ColumnExp> {
    @JsonCreator
    public GreaterThanEqualPredicate(@JsonProperty("left") ColumnExp left,@JsonProperty("right") Exp right) {
        super(left, right);
    }
