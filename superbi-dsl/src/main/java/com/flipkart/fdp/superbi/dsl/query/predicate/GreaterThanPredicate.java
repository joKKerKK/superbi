 ...
 * Time: 5:56 PM
 */
public class GreaterThanPredicate extends BinaryPredicate<ColumnExp>{
    @JsonCreator
    public GreaterThanPredicate(@JsonProperty("left") ColumnExp left,@JsonProperty("right") Exp right) {
        super(left, right);
    }
