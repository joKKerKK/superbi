 ...
 */
public class VerticaDSLConfig extends AbstractDSLConfig {

    private String date_surrugate_key_suffix = "date_key";
    private String time_surrugate_key_suffix = "time_key";
    public static String VERTICA_LOAD_BALANCE = "ConnectionLoadBalance";
    public static String BACKUP_SERVER_NODE = "BackupServerNode";
    public static String VERTICA_JDBC_USERNAME = "User";
    public static String VERTICA_JDBC_PASSWORD = "Password";
    ...
    public VerticaDSLConfig(Map<String, String> overrides) {
