package com.flipkart.fdp.superbi.brv2.util;
...
public class ClassScannerUtil {
  ...
  public static Set<Class> getClasses(final String packageName, Class... parentClasses) {
    ...
    UnmodifiableIterator<ClassPath.ClassInfo> classInfoIterator = ClassPath.from(ClassScannerUtil.class.getClassLoader()).getTopLevelClassesRecursive(packageName).iterator();
